...
export default function PdfSmaPage() {
    return (
...
function PdfSmaContent() {
    ...
    const buildFileName = (): string => {
        ...
        return `${safeNoreg}_${safeNama}_FormulirPPDB_SMA`;
    };
        ...
        <main className="bg-gray-100 min-h-screen py-6 print:bg-white print:py-0">
            <div className="max-w-[820px] mx-auto bg-white shadow-md print:shadow-none">
                ...
                <section className="relative">
                            ...
                            <div>
                                ...
                                <div className="mt-2 text-sm text-gray-900 space-y-0.5">
                                    ...
                                    <div className="text-xs text-gray-700 mt-1 leading-snug">
                                        Pilihan program studi tertentu (LSP/IPA/Bilingual) akan
                                        ditentukan oleh hasil Psikotes/Test Masuk Khusus
                                    </div>
                                </div>
                            </div>
                            <div>
                        ...
                        <div className="mt-4">
                            ...
                            <div className="mt-3 text-sm text-gray-900 space-y-2 leading-relaxed">
                                ...
                                <p className="mt-3">
                                    ...
                                    <span className="font-bold">https://bit.ly/form_ppdbsmak1</span>{" "}
                                    dengan Subject : <span className="font-bold">Asal Sekolah-Nama Siswa-No Registrasi</span>
                                </p>
                                <p className="font-bold">
                                    (softcopy Formulir Pendaftaran ,softcopy Photo Siswa 3 x 4, softcopy KTP Ayah, softcopy KTP Ibu, softcopy Akte lahir, softcopy Kartu Keluarga, softcopy raport 4 semester terakhir (SD : kelas 4-5/SMP : Kelas 7-8) untuk siswa dari luar BPK)
                                </p>
                    ...
                    <div className="mt-2">
                        <img
                            src="/assets/sma/thefutureisyours.gif"
                            alt="Join BPK Penabur, The Future Is Yours"
                            className="w-full h-12 object-cover"
                        />
                    </div>

                    {/* SURAT PERNYATAAN title (still on page 1 like reference) */}
