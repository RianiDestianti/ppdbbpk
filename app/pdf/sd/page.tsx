...
export default function PdfSdPage() {
    return (
...
function PdfSdContent() {
    ...
    const buildFileName = (): string => {
        ...
        return `${safeNoreg}_${safeNama}_FormulirPPDB_SD`;
    };
        ...
        <main className="bg-gray-100 min-h-screen py-6 print:bg-white print:py-0">
            <div className="max-w-[820px] mx-auto bg-white shadow-md print:shadow-none">
                ...
                <section className="relative">
                    ...
                    <div className="px-8 pt-4 pb-6">
                        ...
                        <div className="mt-4 grid grid-cols-[1fr_180px] gap-4">
                            ...
                            <div>
                                ...
                                <div className="mt-2 border border-gray-300 bg-white w-[140px] h-[200px] mx-auto flex items-center justify-center text-sm text-gray-700">
                        ...
                        <div className="mt-4">
                            ...
                            <div className="mt-3 text-sm text-gray-900 space-y-2 leading-relaxed">
                                ...
                                <ol className="space-y-1.5 pl-1">
                                    <li>1. Uang Sumbangan Sarana Pendidikan : Rp___________________ (diisi sesuai petunjuk Operator PPDB)</li>
                                    <li>2. Uang Sumbangan Sukarela : Rp __<span className="font-semibold">{sumbanganSukarela}</span>__ (diisi oleh Orang Tua siswa)</li>
                                    <li>3. Uang Sekolah bulan Juli 2026 : Rp ___________________ (diisi sesuai petunjuk Operator PPDB)</li>
                                </ol>

                                <p className="mt-3">
                                    DOKUMEN SYARAT PENDAFTARAN dikirim dalam bentuk softcopy ke{" "}
                                    <span className="font-bold">admin@pisprimary.penabur.sch.id</span>{" "}
                                    dengan Subject : <span className="font-bold">No registrasi - Nama Siswa</span>
                                </p>
                                <p className="font-bold">
                                    (Photo Siswa 3 x 4, softcopy KTP Ayah, softcopy KTP Ibu, softcopy Akte lahir, softcopy Kartu Keluarga)
                                </p>
                                ...
                                <p>
                                    Untuk Informasi lebih lanjut silahkan menghubungi No WA sekolah : <span className="font-bold">081 7371 686</span>
                                </p>
                    ...
                    {/* JOIN BPK PENABUR banner (green for SD) */}
                    <div className="mt-2">
                        <img
                            src="/assets/sd/thefutureisyours.gif"
